...
class SingleSurveyTest(WBSAPIBaseTestMixin, unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        investor_id = cls.response['data']['data']['list'][0]['investorId']
        cls.view_url = '/ex/investor/doSurvey.json'
        '''answers = [
        ...
        cls.data = 'data={"token":' + str(cls.generate_token()) + ',"param": {"investorId":' + str(investor_id) + \
           ', "answers":' \
           '[{"questionId": "1", "optionId": "2"},' \
           '{"questionId": "2", "optionId": "6"},' \
           '{"questionId": "3", "optionId": "10"},' \
...
class BatchSurveyTest(WBSAPIBaseTestMixin, unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.view_url = '/ex/investor/batchDoSurvey.json'
        cls.data = 'data={' \
