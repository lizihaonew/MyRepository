...
'''
作者：李子浩
内容：顾问云资源市场课程培训二级类别相关page类
'''

from UI.base_page import BasePage
from ...elements.resource_market_elements.class_type_elements import FirstTypeListElements,TypeListElements,AddTypeElements,UpdateTypeElements,DeleteTypeElements

class ClassTypePages(BasePage):
    ...
    def getting_type_page(self):
        ...
        :return: None
        '''
        self.first_type_list.the_class.click()
    ...
    def add_type_do(self):
        ...
        self.add_type.type_name('AutoTestAddClassLZH999')
    ...
    def update_type_do(self):
        ...
        self.update_type.type_name('AutoTestUpdateClassLZH998')
