...
'''
作者：李子浩
内容：顾问云资源市场资源二级类别相关page类
'''

from UI.base_page import BasePage
from ...elements.resource_market_elements.resource_type_elements import FirstTypeListElements,TypeListElements,AddTypeElements,UpdateTypeElements,DeleteTypeElements

class ResourceTypePages(BasePage):
    ...
    def getting_type_page(self):
        ...
        :return: None
        '''
        self.first_type_list.resource.click()
    ...
    def add_type_do(self):
        ...
        self.add_type.type_name('AutoTestAddResourceLZH999')
    ...
    def update_type_do(self):
        ...
        self.update_type.type_name('AutoTestUpdateResourceLZH998')
