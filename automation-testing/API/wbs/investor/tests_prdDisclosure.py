...
@attr('internal')
@attr('externalopen')
class InvestorPrdDisclosureTest(WBSAPIBaseTestMixin, unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.view_url = 'prdDisclosure.json'
        ...
        super(InvestorPrdDisclosureTest, cls).setUpClass()
