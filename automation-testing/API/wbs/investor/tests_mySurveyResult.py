...
@attr('internal')
@attr('externalopen')
class InvestorSurveyResultTest(WBSAPIBaseTestMixin, unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.view_url = 'mySurveyResult.json'
        ...
        super(InvestorSurveyResultTest, cls).setUpClass()
